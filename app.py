...
def send_otp_email(to_email, otp):
    msg = MIMEMultipart()
    msg['From'] = 'abhishekkurne123@gmail.com'
    msg['To'] = to_email
...
def send_new_course_email( email_content):
    email_address = 'abhishekkurne123@gmail.com'  # Your Gmail email address
    app_password = 'vbdl ezme ylvq vvxz'  # Your app-specific password

    to_email = 'abhikurne456@gmail.com'  # Recipient's email address
...
def start_npm():
    try:
        ...
        frontend_project_path =  "/Users/mac/Desktop/onlinelearningplatform-main/templates"
